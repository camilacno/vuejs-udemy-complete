<template>
    ...
    <hr>
    <p v-destaque:fundo.atrasar.alternar="{ cor1: 'green', cor2: 'red', atraso: 2000, intervalo: 200}">Usando diretiva personalizada</p>
    <p v-destaque.atrasar.alternar="{ cor1: 'green', atraso: 3000}">Usando diretiva personalizada</p>
